document.addEventListener('DOMContentLoaded', () => {
    ...
    function validateForm() {
        ...
        signupBtn.disabled = !(isUsernameChecked && isSmsVerified && isPasswordMatch);
    }
    ...
    sendSmsBtn.addEventListener('click', () => {
        ...
        if (/^010-\d{4}-\d{4}$/.test(phone)) {
             ...
             // TODO: Implement timer and resend logic
    ...
    ['username', 'password', 'password-confirm', 'name', 'phone'].forEach(id => {
